...
if [ "$MOD_MANAGER_EXIT_CODE" -ne 0 ]; then
    LogError "Palworld Mod Manager failed with exit code ${MOD_MANAGER_EXIT_CODE}"
    exit "$MOD_MANAGER_EXIT_CODE"
fi

LogInfo "Palworld Mod Manager completed successfully."
